...
var Cufon = function() {
    ...
    function c(e, t) {
        ...
        for (var s = 0, o = r.length; s < o; ++s) {
            i = r[s];
            if (E[i])
                return E[i].get(t.get("fontStyle"), t.get("fontWeight"))
        }
        return null
    }
    function h(e) {
    ...
    function d(e, t, r, i, s, o) {
        var u = i.separate;
        if (u == "none")
            return w[i.engine].apply(null, arguments);
        ...
        for (var h = 0, p = l.length; h < p; ++h)
            f = w[i.engine](e, c ? n.textAlign(l[h], r, h, p) : l[h], r, i, s, o, h < p - 1), f && a.appendChild(f);
        return a
    }
    function v(e, t) {
        var r, i, s, o;
    ...
    var e = function() {
        return e.replace.apply(null, arguments)
            ...
            return t.ready(function() {
                var e = 0, t;
                for (var n = 0, o = s.length; t = s[n], n < o; ++n)
                    !t.disabled && t.rel.toLowerCase() == "stylesheet" && ++e;
            ...
            while (r = s.exec(e))
                r[0] == "," ? (t.push(n), n = {}, i = 0) : r[1] ? n.color = r[1] : n[["offX", "offY", "blur"][i++]] = r[2];
            return t.push(n), t
        }), color: l(function(e) {
            var t = {};
...
Cufon.registerEngine("canvas", function() {
    ...
    return fabric.document.getElementsByTagName("head")[0].appendChild(n), function(t, n, r, i, u, a) {
        ...
        for (var V = Cufon.textOptions.shadowOffsets, b = y.length; b--; )
            V[b] = [y[b][0] * X, y[b][1] * X];
    ...
    if (e && e.getContext && e.getContext.apply)
        return;
    ...
    return t = null, fabric.document.write('<style type="text/css">.cufon-vml-canvas{text-indent:0}@media screen{cvml\\:shape,cvml\\:shadow{behavior:url(#default#VML);display:block;antialias:true;position:absolute}.cufon-vml-canvas{position:absolute;text-align:left}.cufon-vml{display:inline-block;position:relative;vertical-align:middle}.cufon-vml .cufon-alt{position:absolute;left:-10000in;font-size:1px}a .cufon-vml{cursor:pointer}}@media print{.cufon-vml *{display:none}.cufon-vml .cufon-alt{display:inline}}</style>'), function(e, t, i, s, o, u, a) {
        ...
        for (var _ = 0, D = 0, P = N.length; _ < P; ++_)
            A = e.glyphs[N[_]] || e.missingGlyph, A && (C += L = ~~(A.w || e.w) + h);
        if (L === null)
            return null;
...
(function(e) {
    "use strict";
    e.modifyEventListener = !0, e.modifySelectors = !0, e.add = function(e, t, r, i) {
    ...
    var t = function(e) {
        ...
        for (var r in e)
            !e[r] || typeof e[r] != "object" ? n[r] = e[r] : n[r] = t(e[r]);
        return n
    }, n = function(s, o, u, l, d, v) {
        l = l || {};
        if (String(s) === "[object Object]") {
            var m = s;
            s = m.target, o = m.type, u = m.listener, delete m.target, delete m.type, delete m.listener;
            for (var g in m)
                l[g] = m[g]
        }
        if (!s || !o || !u)
        ...
        if (typeof s == "string" && o === "ready") {
            var y = (new Date).getTime(), b = l.timeout, w = l.interval || 1e3 / 60, E = window.setInterval(function() {
                (new Date).getTime() - y > b && window.clearInterval(E), document.querySelector(s) && (window.clearInterval(E), setTimeout(u, 1))
            }, w);
            return
        }
        if (typeof s == "string") {
        ...
        if (s.length > 0 && s !== window) {
            for (var T = 0, N = s.length; T < N; T++)
                S = n(s[T], o, u, t(l), d), S && (x[T] = S);
            return r(x)
        }
        o.indexOf && o.indexOf(" ") !== -1 && (o = o.split(" ")), o.indexOf && o.indexOf(",") !== -1 && (o = o.split(","));
        if (typeof o != "string") {
            if (typeof o.length == "number")
                for (var C = 0, k = o.length; C < k; C++)
                    S = n(s, o[C], u, t(l), d), S && (x[o[C]] = S);
            else
                for (var g in o)
                    typeof o[g] == "function" ? S = n(s, g, o[g], t(l), d) : S = n(s, g, o[g].listener, t(o[g]), d), S && (x[g] = S);
            return r(x)
        }
        if (typeof s != "object")
            return i("Target is not defined!", arguments);
        if (typeof u != "function")
            return i("Listener is not a function!", arguments);
        var L = l.useCapture || !1, A = c(s) + "." + c(u) + "." + (L ? 1 : 0);
        if (e.Gesture && e.Gesture._gestureHandlers[o]) {
            ...
            if (d === "remove") {
                ...
                l.gesture = o, l.target = s, l.listener = u, l.fromOverwrite = v, f[A] = e.proxy[o](l)
            }
            return f[A]
        }
        var M = a(o);
        for (var _ = 0, D; _ < M.length; _++) {
            o = M[_], D = o + "." + A;
            if (d === "remove") {
                if (!f[D])
                    continue;
                s[p](o, u, L), delete f[D]
            } else if (d === "add") {
                if (f[D])
                    return f[D];
                s[h](o, u, L), f[D] = {id: D, type: o, target: s, listener: u, remove: function() {
        ...
        if (typeof console.error == "undefined")
            return;
        console.error(e, t)
    }, s = {msPointer: ["MSPointerDown", "MSPointerMove", "MSPointerUp"], touch: ["touchstart", "touchmove", "touchend"], mouse: ["mousedown", "mousemove", "mouseup"]}, o = {MSPointerDown: 0, MSPointerMove: 1, MSPointerUp: 2, touchstart: 0, touchmove: 1, touchend: 2, mousedown: 0, mousemove: 1, mouseup: 2}, u = function() {
        ...
        return function(t) {
            var n = document.addEventListener ? "" : "on", r = o[t];
            if (isFinite(r)) {
                var i = [];
                for (var u in e.supports)
                    i.push(n + s[u][r]);
                return i
            }
            return[n + t]
    ...
    }, h = document.addEventListener ? "addEventListener" : "attachEvent", p = document.removeEventListener ? "removeEventListener" : "detachEvent";
    return e.createPointerEvent = function(t, n, r) {
        ...
        var t = function(t) {
            var r = function(r) {
                var i = r + "EventListener", s = t[i];
                t[i] = function(t, i, o) {
                    if (e.Gesture && e.Gesture._gestureHandlers[t]) {
                        var u = o;
                        typeof o == "object" ? u.useCall = !0 : u = {useCall: !0, useCapture: o}, n(this, t, i, u, r, !0)
                    } else {
                        var f = a(t);
...
typeof Event.proxy == "undefined" && (Event.proxy = {}), Event.proxy = function(e) {
    ...
    e.pointerSetup = function(e, t) {
        e.doc = e.target.ownerDocument || e.target, e.minFingers = e.minFingers || e.fingers || 1, e.maxFingers = e.maxFingers || e.fingers || Infinity, e.position = e.position || "relative", delete e.fingers, t = t || {}, t.enabled = !0, t.gesture = e.gesture, t.target = e.target, t.env = e.env, Event.modifyEventListener && e.fromOverwrite && (e.oldListener = e.listener, e.listener = Event.createPointerEvent);
        ...
        return e.oldListener && (t.oldListener = e.oldListener), t.listener = e.listener, t.proxy = function(n) {
            ...
            if (t.enabled === !0)
                return;
            e.onPointerDown && Event.add(e.target, r + "down", e.onPointerDown), e.onPointerMove && Event.add(e.doc, r + "move", e.onPointerMove), e.onPointerUp && Event.add(e.doc, r + "up", e.onPointerUp), t.enabled = !0
        }, t.remove = function() {
            if (t.enabled === !1)
                return;
            e.onPointerDown && Event.remove(e.target, r + "down", e.onPointerDown), e.onPointerMove && Event.remove(e.doc, r + "move", e.onPointerMove), e.onPointerUp && Event.remove(e.doc, r + "up", e.onPointerUp), t.reset(), t.enabled = !1
        }, t.pause = function(t) {
    ...
    var t = Event.supports;
    return Event.pointerType = t.mouse ? "mouse" : t.touch ? "touch" : "mspointer", e.pointerStart = function(t, n, r) {
        var i = (t.type || "mousedown").toUpperCase();
        i.indexOf("MOUSE") === 0 ? Event.pointerType = "mouse" : i.indexOf("TOUCH") === 0 ? Event.pointerType = "touch" : i.indexOf("MSPOINTER") === 0 && (Event.pointerType = "mspointer");
        var s = function(e, t) {
            var n = r.bbox, i = u[t] = {};
            switch (r.position) {
                case"absolute":
            ...
            if (r.position === "relative")
                var s = e.pageX + n.scrollLeft - i.offsetX, o = e.pageY + n.scrollTop - i.offsetY;
            else
                var s = e.pageX - i.offsetX, o = e.pageY - i.offsetY;
            i.rotation = 0, i.scale = 1, i.startTime = i.moveTime = (new Date).getTime(), i.move = {x: s, y: o}, i.start = {x: s, y: o}, r.fingers++
        };
        r.event = t, n.defaultListener && (r.listener = n.defaultListener, delete n.defaultListener);
        var o = !r.fingers, u = r.tracker, a = t.changedTouches || e.getCoords(t), f = a.length;
        for (var l = 0; l < f; l++) {
            var c = a[l], h = c.identifier || Infinity;
            if (r.fingers) {
                if (r.fingers >= r.maxFingers) {
                    var p = [];
                    for (var h in r.tracker)
                        p.push(h);
                ...
                u = r.tracker = {}, n.bbox = r.bbox = e.getBoundingBox(r.target), r.fingers = 0, r.cancel = !1, s(c, h)
        }
        var p = [];
        for (var h in r.tracker)
            p.push(h);
        ...
        for (var f in n.tracker) {
            ...
            if (o[f] || l.up)
                continue;
            r && r({pageX: l.pageX, pageY: l.pageY, changedTouches: [{pageX: l.pageX, pageY: l.pageY, identifier: f === "Infinity" ? Infinity : f}]}, "up"), l.up = !0, n.fingers--
        }
        if (n.fingers !== 0)
            return!1;
        var c = [];
        n.gestureFingers = 0;
        for (var f in n.tracker)
            n.gestureFingers++, c.push(f);
        return t.identifier = c.join(","), !0
    }, e.getCoords = function(t) {
        return typeof t.pageX != "undefined" ? e.getCoords = function(e) {
            return Array({type: "mouse", x: e.pageX, y: e.pageY, pageX: e.pageX, pageY: e.pageY, identifier: e.pointerId || Infinity})
        ...
        if ("ontouchstart"in window) {
            ...
            e.getCoord = function(e) {
                ...
                return t && t.length ? {x: n = t[0].pageX, y: r = t[0].pageY} : {x: n, y: r}
            }
        } else
            typeof t.pageX != "undefined" && typeof t.pageY != "undefined" ? e.getCoord = function(e) {
        ...
        t.width = n.width, t.height = n.height, t.x1 = n.left, t.y1 = n.top, t.x2 = t.x1 + t.width, t.y2 = t.y1 + t.height, t.scaleX = n.width / e.offsetWidth || 1, t.scaleY = n.height / e.offsetHeight || 1, t.scrollLeft = 0, t.scrollTop = 0;
        var r = e.parentNode;
        while (r !== null) {
            if (r === document.body)
                break;
            if (r.scrollTop === undefined)
                break;
            var i = window.getComputedStyle(r), s = i.getPropertyValue("position");
            if (s === "absolute")
                break;
            if (s === "fixed") {
                t.scrollTop -= r.parentNode.scrollTop;
                break
            }
            t.scrollLeft += r.scrollLeft, t.scrollTop += r.scrollTop, r = r.parentNode
        }
        return t
    }, function() {
        var t = navigator.userAgent.toLowerCase(), n = t.indexOf("macintosh") !== -1;
        if (n && t.indexOf("khtml") !== -1)
            var r = {91: !0, 93: !0};
        ...
        e.metaTrackerReset = function() {
            e.metaKey = !1, e.ctrlKey = !1, e.shiftKey = !1, e.altKey = !1
        }, e.metaTracker = function(t) {
            var n = !!r[t.keyCode];
            return n && (e.metaKey = t.type === "keydown"), e.ctrlKey = t.ctrlKey, e.shiftKey = t.shiftKey, e.altKey = t.altKey, n
        }
    }(), e
}(Event.proxy);
if (typeof Event == "undefined")
...
Event.MutationObserver = function() {
    var e = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, t = function() {
        var e = document.createElement("p"), t = !1, n = function() {
            t = !0
        };
        if (e.addEventListener)
            e.addEventListener("DOMAttrModified", n, !1);
        else {
            if (!e.attachEvent)
                return!1;
    ...
    return function(n, r) {
        if (e) {
            var i = {subtree: !1, attributes: !0}, s = new e(function(e) {
            ...
            t ? Event.add(n, "DOMAttrModified", function(e) {
                r.call(n, e.attrName)
            }) : "onpropertychange"in document.body && Event.add(n, "propertychange", function(e) {
...
typeof Event.proxy == "undefined" && (Event.proxy = {}), Event.proxy = function(e) {
    ...
    return e.click = function(t) {
        t.gesture = t.gesture || "click", t.maxFingers = t.maxFingers || t.fingers || 1;
        var n;
        t.onPointerDown = function(n) {
            ...
            if (e.pointerEnd(i, r, t)) {
                ...
                if (n.cancelBubble && ++n.bubble > 1)
                    return;
                var s = n.changedTouches || e.getCoords(n), o = s[0], u = t.bbox, a = e.getBoundingBox(t.target);
                if (t.position === "relative")
                    var f = o.pageX + u.scrollLeft - u.x1, l = o.pageY + u.scrollTop - u.y1;
                else
                    var f = o.pageX - u.x1, l = o.pageY - u.y1;
                if (f > 0 && f < u.width && l > 0 && l < u.height && u.scrollTop === a.scrollTop) {
                    for (var c in t.tracker)
                        break;
                    var h = t.tracker[c];
                    r.x = h.start.x, r.y = h.start.y, t.listener(n, r)
                }
            }
        };
...
typeof Event.proxy == "undefined" && (Event.proxy = {}), Event.proxy = function(e) {
    ...
    return e.dbltap = e.dblclick = function(t) {
        ...
        t.onPointerDown = function(f) {
            ...
            var f = t.bbox;
            if (t.position === "relative")
                var l = u.pageX + f.scrollLeft - f.x1, c = u.pageY + f.scrollTop - f.y1;
            else
                var l = u.pageX - f.x1, c = u.pageY - f.y1;
            ...
            e.pointerEnd(o, a, t) && (Event.remove(t.doc, "mousemove", t.onPointerMove), Event.remove(t.doc, "mouseup", t.onPointerUp));
            if (r && i) {
                if (i <= n && !(o.cancelBubble && ++o.bubble > 1)) {
                    a.state = t.gesture;
                    for (var u in t.tracker)
                        break;
                    var f = t.tracker[u];
...
typeof Event.proxy == "undefined" && (Event.proxy = {}), Event.proxy = function(e) {
    ...
    return e.dragElement = function(t, n) {
        ...
        t.gesture = "drag", t.onPointerDown = function(r) {
            ...
            if (!t.tracker)
                return t.onPointerDown(r);
            var s = t.bbox, o = r.changedTouches || e.getCoords(r), u = o.length;
            for (var a = 0; a < u; a++) {
                var f = o[a], l = f.identifier || Infinity, c = t.tracker[l];
                if (!c)
                    continue;
                c.pageX = f.pageX, c.pageY = f.pageY, n.state = i || "move", n.identifier = l, n.start = c.start, n.fingers = t.fingers, t.position === "differenceFromLast" ? (n.x = c.pageX - c.offsetX, n.y = c.pageY - c.offsetY, c.offsetX = c.pageX, c.offsetY = c.pageY) : t.position === "relative" ? (n.x = c.pageX + s.scrollLeft - c.offsetX, n.y = c.pageY + s.scrollTop - c.offsetY) : (n.x = c.pageX - c.offsetX, n.y = c.pageY - c.offsetY), t.listener(r, n)
            }
...
typeof Event.proxy == "undefined" && (Event.proxy = {}), Event.proxy = function(e) {
    ...
    return e.gesture = function(n) {
        n.gesture = n.gesture || "gesture", n.minFingers = n.minFingers || n.fingers || 2, n.onPointerDown = function(t) {
            var i = n.fingers;
            ...
            for (var l = 0; l < f; l++) {
                ...
                if (!p)
                    continue;
                n.position === "relative" ? (p.move.x = c.pageX + o.scrollLeft - o.x1, p.move.y = c.pageY + o.scrollTop - o.y1) : (p.move.x = c.pageX - o.x1, p.move.y = c.pageY - o.y1)
            }
        ...
        t.onPointerDown = function(s) {
            ...
            for (var o = 0; o < s; o++) {
                ...
                if (!f)
                    continue;
                if (t.position === "relative")
                    var l = u.pageX + r.scrollLeft - r.x1, c = u.pageY + r.scrollTop - r.y1;
                else
                    var l = u.pageX - r.x1, c = u.pageY - r.y1;
                var h = l - f.start.x, p = c - f.start.y, d = Math.sqrt(h * h + p * p);
            ...
            if (e.pointerEnd(s, i, t)) {
                ...
                if (t.cancel)
                    return;
                if ((new Date).getTime() - n > t.timeout)
                    return;
...
typeof Event.proxy == "undefined" && (Event.proxy = {}), Event.proxy = function(e) {
    ...
    return e.wheel = function(e) {
        var t, n = e.timeout || 150, r = 0, i = {gesture: "wheel", state: "start", wheelDelta: 0, target: e.target, listener: e.listener, preventElasticBounce: function() {
                var e = this.target, t = e.scrollTop, n = t + e.offsetHeight, r = e.scrollHeight;
                n === r && this.wheelDelta <= 0 ? Event.cancel(event) : t === 0 && this.wheelDelta >= 0 && Event.cancel(event), Event.stop(event)
            }, add: function() {
                e.target[o](a, s, !1)
            }, remove: function() {
                e.target[u](a, s, !1)
        ...
        }, o = document.addEventListener ? "addEventListener" : "attachEvent", u = document.removeEventListener ? "removeEventListener" : "detachEvent", a = Event.getEventSupport("mousewheel") ? "mousewheel" : "DOMMouseScroll";
...
typeof Event.proxy == "undefined" && (Event.proxy = {}), Event.proxy = function(e) {
    ...
    return e.orientation = function(e) {
        var t = {gesture: "orientationchange", previous: null, current: window.orientation, target: e.target, listener: e.listener, remove: function() {
...
(function(e) {
    ...
    fabric.util = {removeFromArray: function(e, t) {
            ...
            var n = [[e[0], e[2], e[4]], [e[1], e[3], e[5]], [0, 0, 1]], r = [[t[0], t[2], t[4]], [t[1], t[3], t[5]], [0, 0, 1]], i = [];
            for (var s = 0; s < 3; s++) {
                i[s] = [];
                for (var o = 0; o < 3; o++) {
                    var u = 0;
...
(function() {
    ...
    a ? (h = function(e, t, n) {
        ...
        var i = n(e), s;
        if (l[i] && l[i][t])
            for (var o = 0, u = l[i][t].length; o < u; o++)
                s = l[i][t][o], s && s.handler === r && (e.detachEvent("on" + t, s.wrappedHandler), l[i][t][o] = null)
    }) : (h = function(e, t, r) {
        var i = n(e);
        c[i] || (c[i] = {});
        if (!c[i][t]) {
...
(function(e) {
    ...
    n(t, {resolveGradients: function(e) {
            ...
            i = t.length;
            for (; i--; )
                r = t[i], s[r.getAttribute("id")] = r;
            i = n.length;
            for (; i--; )
                r = n[i], s[r.getAttribute("id")] = r;
            return s
            ...
            if (t) {
                ...
                r = 0, i = e.length;
                for (; r < i; r += 2)
                    n.push({x: parseFloat(e[r]), y: parseFloat(e[r + 1])})
            }
...
fabric.ElementsParser = {parse: function(e, t, n, r) {
        ...
        for (var e = 0, t = this.elements.length; e < t; e++)
            this.createObject(this.elements[e], e)
...
(function() {
    ...
    function i(e, t, n) {
        if (t === "x1" || t === "x2")
            e[t] -= fabric.util.toFixed(n.width / 2, 2);
        else if (t === "y1" || t === "y2")
    ...
    fabric.Gradient = fabric.util.createClass({initialize: function(e) {
            ...
            for (var i = 0; i < this.colorStops.length; i++)
                r.push("<stop ", 'offset="', this.colorStops[i].offset * 100 + "%", '" style="stop-color:', this.colorStops[i].color, this.colorStops[i].opacity ? ";stop-opacity: " + this.colorStops[i].opacity : ";", '"/>');
...
(function() {
    ...
    fabric.StaticCanvas = fabric.util.createClass({initialize: function(e, t) {
            ...
            for (var n = 0, r = this._objects.length; n < r; ++n)
                (!t || t && this._objects[n] && !t.contains(this._objects[n])) && this._draw(e, this._objects[n])
...
fabric.SprayBrush = fabric.util.createClass(fabric.BaseBrush, {width: 10, density: 20, dotWidth: 1, dotWidthVariance: 1, randomOpacity: !1, optimizeOverlapping: !0, initialize: function(e) {
        ...
        this.canvas.add(a), this.canvas.fire("path:created", {path: a}), this.canvas.clearContext(this.canvas.contextTop), this._resetShadow(), this.canvas.renderOnAddRemove = e, this.canvas.renderAll()
...
(function() {
    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {_initEventListeners: function() {
            ...
            if (!t || !t.selectable)
                return n.cursor = this.defaultCursor, !1;
            ...
            if (e in t)
                r.cursor = this._getRotatedCornerCursor(e, n);
            else {
                if (e !== "mtr" || !n.hasRotatingPoint)
                    return r.cursor = this.defaultCursor, !1;
...
(function() {
    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {__onTransformGesture: function(e, t) {
            if (this.isDrawingMode || e.touches.length !== 2 || "gesture" !== t.gesture)
                return;
...
(function(e) {
    ...
    t.Object = t.util.createClass({type: "object", originX: "left", originY: "top", top: 0, left: 0, width: 0, height: 0, scaleX: 1, scaleY: 1, flipX: !1, flipY: !1, opacity: 1, angle: 0, cornerSize: 12, transparentCorners: !0, hoverCursor: null, padding: 0, borderColor: "rgba(102,153,255,0.75)", cornerColor: "rgba(102,153,255,0.5)", centeredScaling: !1, centeredRotation: !0, fill: "rgb(0,0,0)", fillRule: "source-over", backgroundColor: "", stroke: null, strokeWidth: 1, strokeDashArray: null, strokeLineCap: "butt", strokeLineJoin: "miter", strokeMiterLimit: 10, shadow: null, borderOpacityWhenMoving: .4, borderScaleFactor: 1, transformMatrix: null, minScaleLimit: .01, selectable: !0, evented: !0, visible: !0, hasControls: !0, hasBorders: !0, hasRotatingPoint: !0, rotatingPointOffset: 40, perPixelTargetFind: !1, includeDefaultValues: !0, clipTo: null, lockMovementX: !1, lockMovementY: !1, lockRotation: !1, lockScalingX: !1, lockScalingY: !1, lockUniScaling: !1, stateProperties: "top left width height scaleX scaleY flipX flipY originX originY transformMatrix stroke strokeWidth strokeDashArray strokeLineCap strokeLineJoin strokeMiterLimit angle opacity fill fillRule shadow clipTo visible backgroundColor".split(" "), initialize: function(e) {
            ...
            if (typeof e == "object")
                ...
                typeof t == "function" && e !== "clipTo" ? this._set(e, t(this.get(e))) : this._set(e, t);
            return this
        }, _set: function(e, n) {
    ...
    fabric.util.object.extend(fabric.Object.prototype, {_controlsVisibility: null, _findTargetCorner: function(t, n) {
            ...
            for (var a in this.oCoords) {
                if (!this.isControlVisible(a))
                    continue;
                if (a === "mtr" && !this.hasRotatingPoint)
                    continue;
                if (!(!this.get("lockUniScaling") || a !== "mt" && a !== "mr" && a !== "mb" && a !== "ml"))
                    continue;
                u = this._getImageLines(this.oCoords[a].corner), o = this._findCrossPoints({x: i, y: s}, u);
                if (o !== 0 && o % 2 === 1)
                    return this.__corner = a, a
            }
            return!1
    ...
    n.Path = n.util.createClass(n.Object, {type: "path", initialize: function(e, t) {
            ...
            for (var a = 0, f, l = this.path.length; a < l; a++) {
                ...
                for (var c = 0, h = n.length; c < h; c++)
                    i = parseFloat(n[c]), isNaN(i) || f.push(i);
                var p = f[0].toLowerCase(), d = t[p];
                if (f.length - 1 > d)
                    for (var v = 1, m = f.length; v < m; v += d)
                        e.push([f[0]].concat(f.slice(v, v + d)));
                else
                    e.push(f)
            }
            return e
...
(function(e) {
    ...
    t.Group = t.util.createClass(t.Object, t.Collection, {type: "group", initialize: function(e, t) {
            ...
            for (var r = 0, i = this._objects.length; r < i; r++)
                this._renderObject(this._objects[r], e);
            ...
            for (var r = 0, i = this._objects.length; r < i; ++r) {
                ...
                for (var s in n.oCoords)
                    e.push(n.oCoords[s].x), t.push(n.oCoords[s].y)
            }
...
(function(e) {
    ...
    t.Image.filters.Noise = t.util.createClass(t.Image.filters.BaseFilter, {type: "Noise", initialize: function(e) {
            ...
            for (var o = 0, u = r.length; o < u; o += 4)
                s = (.5 - Math.random()) * i, r[o] += s, r[o + 1] += s, r[o + 2] += s;
            t.putImageData(n, 0, 0)
        }, toObject: function() {
...
(function(e) {
    ...
    t.Image.filters.Sepia = t.util.createClass(t.Image.filters.BaseFilter, {type: "Sepia", applyTo: function(e) {
            ...
            for (s = 0; s < i; s += 4)
                o = .3 * r[s] + .59 * r[s + 1] + .11 * r[s + 2], r[s] = o + 100, r[s + 1] = o + 50, r[s + 2] = o + 255;
            t.putImageData(n, 0, 0)
...
(function(e) {
    ...
    t.Image.filters.Sepia2 = t.util.createClass(t.Image.filters.BaseFilter, {type: "Sepia2", applyTo: function(e) {
            ...
            for (s = 0; s < i; s += 4)
                o = r[s], u = r[s + 1], a = r[s + 2], r[s] = (o * .393 + u * .769 + a * .189) / 1.351, r[s + 1] = (o * .349 + u * .686 + a * .168) / 1.203, r[s + 2] = (o * .272 + u * .534 + a * .131) / 2.14;
            t.putImageData(n, 0, 0)
